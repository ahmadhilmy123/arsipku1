...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>
      ArsipKu - Pengelolaan Surat Berbasis AI
    </title>
    <link
      rel="shortcut icon"
      ...
      <div class="container px-4 mx-auto">
        <div class="relative flex items-center justify-between -mx-4">
          <div class="max-w-full px-4 w-60">
            ...
            <a  class="d-block py-3 text-center">
                <img
        ...
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full px-4">
            ...
            >
              ...
              >
                Kelola Surat dengan Cerdas Bersama ArsipKu
              </h1>
              <p
                class="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]"
              >
               Catat, klasifikasikan, dan cari surat Anda dengan teknologi AI modern.
              </p>
              <ul
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
              ...
              >
                Fitur Unggulan Arsipku
              </h2>
              <p class="text-base text-body-color dark:text-dark-6">
                Meningkatkan efisiensi pengelolaan surat Anda.
              </p>
            </div>
          </div>
        </div>
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="mb-12 wow fadeInUp group" data-wow-delay=".1s">
              ...
              <h4 class="mb-3 text-xl font-bold text-dark dark:text-white">
                Pencatatan Surat Otomatis
              </h4>
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                Input surat masuk dan keluar dengan sistem otomatis berbasis AI.
              </p>
              <a
                href="javascript:void(0)"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="mb-12 wow fadeInUp group" data-wow-delay=".15s">
              ...
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                Surat dikategorikan otomatis berdasarkan isi dan tujuan surat.
              </p>
              <a
                href="javascript:void(0)"
                class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="mb-12 wow fadeInUp group" data-wow-delay=".2s">
              ...
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                Temukan surat dengan cepat menggunakan kata kunci atau filter tertentu.
              </p>
              <a
                href="javascript:void(0)"
                class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="mb-12 wow fadeInUp group" data-wow-delay=".25s">
              ...
              <h4 class="mb-3 text-xl font-bold text-dark dark:text-white">
                Pengingat & Notifikasi Surat
              </h4>
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                membantu mengingatkan pengguna tentang surat-surat yang memiliki tenggat waktu melalui notifikasi otomatis, agar tidak terlewat.
              </p>
              <a
                href="javascript:void(0)"
                class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
          ...
          <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4 lg:w-1/2">
              <div class="mb-12 max-w-[540px] lg:mb-0">
                ...
                >
                  ArsipKu adalah solusi teknologi informasi berupa website pengelolaan arsip surat berbasis kecerdasan buatan (AI) yang dirancang khusus untuk membantu pengguna dalam mengelola dokumen surat secara praktis dan efisien.
                  <br />
                  <br />
                  Penerapan AI dalam manajemen arsip dan dokumen telah menunjukkan potensi besar dalam meningkatkan efisiensi dan akurasi pengelolaan data.
                </p>
          ...
          <div class="flex flex-wrap items-stretch -mx-4">
            <div class="w-full px-4">
              <div class="mx-auto max-w-[570px] text-center">
                ...
                >
                  Kelola arsip surat Anda dengan lebih mudah, cepat, dan cerdas bersama ArsipKu. Nikmati fitur otomatisasi pencatatan, klasifikasi berbasis AI, dan pencarian surat yang efisien — semua dalam satu platform.
                </p>
                <a
                  href="javascript:void(0)"
          ...
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[510px] text-center">
              ...
              <h2
                class="mb-3 text-3xl font-bold text-dark dark:text-white sm:text-4xl md:text-[40px] md:leading-[1.2]"
              >
                Paket Harga Menarik dari ArsipKu
              </h2>
              <p class="text-base text-body-color dark:text-dark-6">
                ArsipKu menawarkan berbagai pilihan paket yang disesuaikan untuk kebutuhan pengelolaan arsip surat Anda.
              </p>
            </div>
          </div>
        </div>
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              >
                ...
                <span class="-ml-1 -tracking-[2px]">Gratis</span>
                <span
              ...
              <div class="mb-[50px]">
                ...
                <div class="flex flex-col gap-[14px]">
                  <p class="text-base text-body-color dark:text-dark-6">
                    Penyimpanan hingga 100 surat
                  </p>
                  <p class="text-base text-body-color dark:text-dark-6">
                    Pencatatan surat masuk & keluar manual
                  </p>
                  <p class="text-base text-body-color dark:text-dark-6">
                    Pencarian berdasarkan judul & tanggal
                  </p>
                  <p class="text-base text-body-color dark:text-dark-6">
                    1 pengguna aktif
                  </p>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              >
                <span class="text-xl font-medium">Rp</span>
                <span class="-ml-1 -tracking-[2px]">49.000</span>
                <span
                  class="text-base font-normal text-body-color dark:text-dark-6"
                >
                  1 Bulan
              ...
              <div class="mb-[50px]">
                ...
                <div class="flex flex-col gap-[14px]">
                  <p class="text-base text-body-color dark:text-dark-6">
                    Penyimpanan hingga 2.000 surat
                  </p>
                  <p class="text-base text-body-color dark:text-dark-6">
                    Pencatatan otomatis surat masuk & keluar
                  </p>
                  <p class="text-base text-body-color dark:text-dark-6">
                    Pencarian cerdas & filter lanjutan
                  </p>
                  <p class="text-base text-body-color dark:text-dark-6">
                    5 pengguna aktif
                  </p>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              >
                <span class="text-xl font-medium">Rp</span>
                <span class="-ml-1 -tracking-[2px]">149.000</span>
                <span
                  class="text-base font-normal text-body-color dark:text-dark-6"
                >
                  1 Bulan
              ...
              <div class="mb-[50px]">
                ...
                <div class="flex flex-col gap-[14px]">
                  ...
                  <p class="text-base text-body-color dark:text-dark-6">
                    Pencatatan otomatis + pengingat disposisi
                  </p>
                  <p class="text-base text-body-color dark:text-dark-6">
                    Klasifikasi AI & pelabelan custom
                  </p>
                  <p class="text-base text-body-color dark:text-dark-6">
                    20+ pengguna aktif
                  </p>
        ...
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[485px] text-center">
              ...
              >
                Apa Kata Pengguna ArsipKu
              </h2>
              <p class="text-base text-body-color dark:text-dark-6">
                Berbagai kalangan telah merasakan kemudahan dalam mengelola arsip surat menggunakan ArsipKu.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[520px] text-center">
              ...
              >
                Kami memahami bahwa Anda mungkin memiliki beberapa pertanyaan tentang cara kerja ArsipKu. Berikut adalah beberapa pertanyaan yang sering ditanyakan seputar pengelolaan arsip surat dengan ArsipKu.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="w-full px-4 lg:w-1/2">
            <div class="mb-12 flex lg:mb-[70px]">
              ...
              <div class="w-full">
                ...
                >
                  Siapa saja yang bisa menggunakan ArsipKu?
                </h3>
                <p class="text-base text-body-color dark:text-dark-6">
                  Mahasiswa, organisasi kampus, dan instansi bisa menggunakan ArsipKu sesuai kebutuhan.
                  Platform ini fleksibel dan mudah diakses oleh berbagai kalangan.
                </p>
              </div>
            </div>
            <div class="mb-12 flex lg:mb-[70px]">
              ...
              <div class="w-full">
                <h3
                  class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl"
                >
                  Apakah ArsipKu menggunakan AI?
                </h3>
                <p class="text-base text-body-color dark:text-dark-6">
                  Ya, ArsipKu memakai AI untuk klasifikasi otomatis berdasarkan isi surat.
                  Fitur ini membantu pengarsipan jadi lebih cepat dan akurat.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="mb-12 flex lg:mb-[70px]">
              ...
              <div class="w-full">
                <h3
                  class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl"
                >
                  Apakah data saya aman di ArsipKu?
                </h3>
                <p class="text-base text-body-color dark:text-dark-6">
                 Data Anda dienkripsi dan hanya bisa diakses oleh pengguna berizin.
                 Sistem juga dilengkapi backup dan perlindungan keamanan.
                </p>
              </div>
            </div>
            <div class="mb-12 flex lg:mb-[70px]">
              ...
              <div class="w-full">
                <h3
                  class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl"
                >
                  Bisakah saya mencari surat lama dengan cepat?
                </h3>
                <p class="text-base text-body-color dark:text-dark-6">
                  Bisa, cukup gunakan fitur pencarian berdasarkan kata kunci atau tanggal.
                  Prosesnya cepat tanpa perlu membuka dokumen satu per satu.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[485px] text-center">
              ...
              <h2
                class="mb-3 text-3xl font-bold leading-[1.2] text-dark dark:text-white sm:text-4xl md:text-[40px]"
              >
                Tim Kreatif di Balik ArsipKu
              </h2>
              <p class="text-base text-body-color dark:text-dark-6">
                ArsipKu dikembangkan oleh tim beranggotakan 7 orang yang berdedikasi dalam menciptakan solusi pengelolaan arsip surat yang cerdas, efisien, dan mudah digunakan. Kami percaya bahwa teknologi harus mempermudah, bukan mempersulit.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[485px] text-center">
              ...
              >
                Berita & Informasi Terbaru dari ArsipKu
              </h2>
              <p class="text-base text-body-color dark:text-dark-6">
                Dapatkan wawasan, tips, dan pembaruan terkini seputar pengelolaan arsip surat digital, teknologi AI, dan fitur terbaru dari ArsipKu. Kami berbagi informasi untuk membantu Anda mengelola dokumen lebih efisien setiap hari.
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="mb-10 wow fadeInUp group" data-wow-delay=".1s">
              ...
              <div>
                ...
                <h3>
                  ...
                  >
                    Universitas Cendekia Digital Terapkan ArsipKu untuk Otomatisasi Surat Masuk-Keluar
                  </a>
                </h3>
                <p
                  class="max-w-[370px] text-base text-body-color dark:text-dark-6"
                >
                  Universitas Cendekia Digital resmi mengimplementasikan ArsipKu sebagai sistem utama pencatatan dan pengelolaan surat masuk dan keluar. Dengan bantuan fitur klasifikasi AI dari ArsipKu, pihak biro tata usaha kini dapat memproses lebih dari 200 surat per minggu secara otomatis dan terstruktur.
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <h3>
                  <a
                    ...
                    class="inline-block mb-4 text-xl font-semibold text-dark hover:text-primary dark:text-white dark:hover:text-primary sm:text-2xl lg:text-xl xl:text-2xl"
                  >
                    BEM Fakultas Hukum Gunakan ArsipKu untuk Mengelola Surat Kegiatan
                  </a>
                </h3>
                <p
                  class="max-w-[370px] text-base text-body-color dark:text-dark-6"
                >
                  Badan Eksekutif Mahasiswa (BEM) Fakultas Hukum Universitas Pertiwi memanfaatkan ArsipKu untuk mendigitalisasi semua arsip surat permohonan kegiatan, peminjaman ruang, hingga undangan diskusi publik.
                  Dengan ArsipKu, semua surat bisa diklasifikasikan otomatis dan mudah dicari kembali lewat fitur pencarian cerdas.
                </p>
              </div>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="mb-10 wow fadeInUp group" data-wow-delay=".2s">
              <div class="mb-8 overflow-hidden rounded-[5px]">
                <a href="blog-details.html" class="block">
                  <img
                    src="./assets/images/blog/blog-03.jpeg"
                    alt="image"
                    class="w-full transition group-hover:rotate-6 group-hover:scale-125"
                  />
                </a>
              ...
              <div>
                ...
                <h3>
                  <a
                    ...
                    class="inline-block mb-4 text-xl font-semibold text-dark hover:text-primary dark:text-white dark:hover:text-primary sm:text-2xl lg:text-xl xl:text-2xl"
                  >
                    Dinas Perpustakaan Kota Semarang Lakukan Uji Coba ArsipKu untuk Keperluan Internal
                  </a>
                </h3>
                <p
                  class="max-w-[370px] text-base text-body-color dark:text-dark-6"
                >
                  Dalam rangka meningkatkan efisiensi pengelolaan dokumen internal, Dinas Perpustakaan Kota Semarang melakukan uji coba ArsipKu selama 3 bulan. Hasilnya, sistem ini terbukti mengurangi kesalahan pencatatan dan mempermudah pelacakan dokumen antar-bagian.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div class="ud-contact-content-wrapper">
              <div class="ud-contact-title mb-12 lg:mb-[150px]">
                ...
                >
                  Mari bicarakan kebutuhan atau masalah Anda.
                </h2>
              </div>
              ...
              <form>
                ...
                <div class="mb-[22px]">
                  ...
                  <input
                    type="email"
                    name="email"
                    placeholder="ariadilah05@gmail.com"
                    class="w-full border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-body-color placeholder:text-body-color/60 focus:border-primary focus:outline-hidden dark:border-dark-3 dark:text-dark-6"
                  />
                </div>
                <div class="mb-[22px]">
          ...
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div class="w-full mb-10">
              ...
              <p class="mb-8 max-w-[270px] text-base text-gray-7">
                Kami menciptakan solusi pengelolaan arsip digital untuk individu, organisasi, dan instansi melalui teknologi cerdas.
              </p>
